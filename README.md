...
* **BIOS version**: GLCN63WW (the latest version is entirely broken on my end, even if you're just using a typical OS)
...
I don't know if this issue is specifically because the internal display of my laptop is detached, but after installing macOS, you'll need temporarily use WhateverGreen and remove NootedRed just to get through the initial setup screen, since apparently, the wizard window is off-screen.
